...
if role == "Admin":
    tab_log, tab_deck, tab_admin_decks, tab_admin_matches, tab_stats = st.tabs([
        "⚔️ Log Match", "➕ Add Deck", "🛠️ Deck & Player Admin", "✏️ Match Admin", "📊 Analytics"
    ])
elif role == "Logger":
...
# ------------------------------------------------------------------------------
# TAB 5: ANALYTICS (PUBLIC / ALL ROLES)
# ------------------------------------------------------------------------------
with tab_stats:
